...
**2026-09-08 현재:** 빌드 4가 기존 버전에 연결됐고 공개 심사 CLI 점검은 오류·경고 0이다. App Privacy 게시, 연령 설문·심사 연락처와 CAN/USA/KOR 배포 국가 설정을 완료했다. 실제 계정 인증·탈퇴 검증과 공개 심사 제출은 별도이며 [후속 기록](../../tasks/release-followup-2026-09-08.md)을 따른다. 아래는 빌드 2 작업 당시 기록이다.
